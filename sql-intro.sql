...
-- DELETE or REMOVE a table permanently

DROP TABLE "songs";


-- CREATE, INSERT, or POST information into a table

INSERT INTO "songs" ("artist", "published", "rank", "track")
VALUES ('Oasis', '1-1-1996', NULL, 'Wonderwall');
...
-- READ or GET information from a table
...
SELECT * FROM "songs"
WHERE "track" LIKE '%ack%';

SELECT * FROM "songs"
WHERE "published" > '1/1/2000';
...
UPDATE "songs" SET "artist" = 'Chris Black' WHERE "id" = 6;

UPDATE "songs" SET "artist" = 'Ke$ha', "track" = 'Tik-Toc Clock'
WHERE "id" = 6;
...
DELETE FROM "songs" WHERE "artist" = 'Elvis Presley';
